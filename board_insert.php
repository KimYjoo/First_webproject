...
<?php
	...
	if ($upfile_name && !$upfile_error)
	{
		...
		if (move_uploaded_file($upfile_tmp_name, $uploaded_file) > 0)
		{
	...
	$sql = "insert into board (login_id, Name, subject, content, regist_day, hit,  file_name, file_type, file_copied) ";
	$sql .= "values('$login_id', '$user_name', '$subject', '$content', '$regist_day', 0, ";
